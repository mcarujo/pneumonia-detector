...
def train():
    ...
    metrics = [('Accuracy', metrics['ac']), ('F1 Score', metrics['f1']), ('Log Loss',
                                                                          metrics['ll']), ('Precision', metrics['ps']), ('Recall', metrics['rc'])]
...
def predict():
    ...
    return render_template('predict.html', accuracy=prediction[0], class_=prediction[0].round())
